...
# -------------------------
load_dotenv()
MODEL_PATH = os.getenv("MODEL_PATH", "./fine_tuned_distilbert")
...
# SQLAlchemy connection string - using Railway MySQL environment variables
# For Railway: use public URL for external connections
...
try:
    # Import lazily so missing ML deps do not crash the entire web service.
    ...
    print("⚠️ Service will stay online, but /predict will return 503 until model loads successfully.")
